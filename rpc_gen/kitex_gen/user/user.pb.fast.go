...
func (x *UserInfoResp) fastReadField5(buf []byte, _type int8) (offset int, err error) {
	x.CreatedAt, offset, err = fastpb.ReadString(buf, _type)
	return offset, err
}

func (x *UserInfoResp) fastReadField6(buf []byte, _type int8) (offset int, err error) {
...
func (x *UserInfoResp) fastWriteField5(buf []byte) (offset int) {
	if x.CreatedAt == "" {
		return offset
	}
...
func (x *UserInfoResp) fastWriteField6(buf []byte) (offset int) {
	if x.UpdatedAt == "" {
		return offset
	}
...
func (x *UserInfoResp) sizeField5() (n int) {
	if x.CreatedAt == "" {
		return n
	}
...
func (x *UserInfoResp) sizeField6() (n int) {
	if x.UpdatedAt == "" {
		return n
	}
